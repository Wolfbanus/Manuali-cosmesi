...
\begin{figure}[H]
	\includegraphics[width=\textwidth]{15e924e1-b025-4d84-bbdd-92cf72f5ad6e-1_780_1090_1311_517}
%	\caption{}
\end{figure}
...
Rimozione delle lenti, macchie e rughe.

Tonificazione della pelle

Trattamento dell'acne e sollievo dal dolore.
...
$1 \times$ dispositivo principale in silicone PDT\\
$1 \times$ Telecomando\\
$1 \times$ cavo di ricarica USB\\
1 adattatore $12 \mathrm{~V} / 4 \mathrm{~A}$\\
$1 \times$ Poggiatesta\\
...
$1 \times$ Cinghia di fissaggio\\
$1 \times$ Occhiali protettivi\\
$2 \times$ Staffe di supporto\\
$1 \times$ Manuale utente\\
...
Rapporto LED: 415:590:630:850 = 1:1:1:1

Dimensioni: $680 \times 257 \times 8,5 \mathrm{~mm}$

Peso: 1.300 g (compreso il controller)

Regolazione: 4 modalità, 3 livelli di luminosità, timer.

Regolatore del tempo di ricarica: 2,5 minerali
...
Visualizzazione del segnale di connessione
