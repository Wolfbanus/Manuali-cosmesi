...
\title{\Huge{ELETTROPULSE+\\Manuale d'uso}}
\date{}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{elettro_pulse+}
%	\caption{}
%	\label{fig:copertina}
\end{figure}
...
\subsection{Lista imballaggio}

\begin{center}
\includegraphics[max width=\textwidth, alt={}]{d940fc92-c117-4fc3-b16c-db659decd2a5-03_1273_1648_301_244}
\end{center}

\subsection{Adesivo posteriore}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{images/adesivo_posteriore}
\end{figure}
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|X|l|}
		\hline
		\includegraphics[width=\linewidth]{d940fc92-c117-4fc3-b16c-db659decd2a5-03_88_72_2199_331}
		& RAEE - Rifiuti di Apparecchiature Elettriche ed Elettroniche \\
		\hline
		\includegraphics[width=\linewidth]{d940fc92-c117-4fc3-b16c-db659decd2a5-03_66_84_2349_338}
		& Manuale utente \\
		\hline
		\includegraphics[width=\linewidth]{CE_marchio} & Conformità europea \\
		\hline
	\end{tabularx}
\end{table}
...
\begin{enumerate}
  ...
  \item A nessuno è consentito smontare la macchina o le sue parti interne. meno di ciò è autorizzato dalla nostra azienda. % correggere
  \item Se non si utilizza la macchina per più di 2 ore, spegnere l'alimentazione. 
  \item Questa apparecchiatura è dotata di messa a terra.
\end{enumerate}
...
\begin{enumerate}
  ...
  \item Questa macchina può essere utilizzata solo nell'ambito del presente manuale.
\end{enumerate}
...
%\subsection{Esecutivo standard} % non esiste?
...
\begin{tabular}{|l|ccc|c|}
	\hline
	Tipo di tecnologia & \multicolumn{3}{c|}{Vibrazione} & Radiofrequenza \\
	\hline
	Gamma di energia   & \multicolumn{3}{c|}{0-3}      & 1-5 \\
	\hline
	Frequenza di uscita & Energia 1 & Energia 2 & Energia 3 & 1 MHz \\
	\hline
	& 100 Hz    & 125 Hz    & 150 Hz    &      \\
	\hline
\end{tabular}
...
\subsection{Controllo e installazione dell'imballaggio}
...
\textbf{Avvertimento: La macchina non può essere posizionata in un ambiente infiammabile ed esplosivo.}

\subsection{Installazione del supporto a 2 maniglie}
...
\begin{enumerate}
	...
	\begin{enumerate}
		\item 
		Aprire la cartella e inserire la piastra.\\
		\includegraphics[width=0.6\textwidth]{d940fc92-c117-4fc3-b16c-db659decd2a5-06_346_494_520_1030}
		\\
		\item 
		Chiudere la cartella.\\
		\includegraphics[width=0.6\textwidth]{d940fc92-c117-4fc3-b16c-db659decd2a5-06_344_483_979_1041}
		\\
		\item 
		l'installazione è completa\\
		\includegraphics[width=0.6\textwidth]{d940fc92-c117-4fc3-b16c-db659decd2a5-06_341_481_1407_1041}\\
	\end{enumerate}
	\item 
	Collegare il cavo di alimentazione
	\begin{enumerate}
		\item 
		\includegraphics[width=0.6\textwidth]{d940fc92-c117-4fc3-b16c-db659decd2a5-06_273_437_2252_370}\\
		\item 
		\includegraphics[width=0.6\textwidth]{d940fc92-c117-4fc3-b16c-db659decd2a5-06_285_414_2240_863}\\
		\item 
		\includegraphics[width=0.6\textwidth]{d940fc92-c117-4fc3-b16c-db659decd2a5-06_282_377_2229_1334}
	\end{enumerate}
...
\begin{enumerate}
 	\item 
 	Avviare la macchina: accendere l'alimentazione. La spia luminosa sarà accesa;\\
	\includegraphics[max width=\textwidth, alt={}, center]{d940fc92-c117-4fc3-b16c-db659decd2a5-07_584_1328_552_331}
	\item
	Il sistema entra nell'interfaccia operativa
	\begin{figure}[H]
		\centering
...
\textbf{Avvertimento:}
\begin{enumerate}
  \item \textbf{Durante il lavoro, continua a muoverti invece di rimanere troppo a lungo in una determinata area.}
  \item \textbf{Non curare mai persone con dispositivi elettronici nel corpo (come pacemaker)!!!}
\end{enumerate}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.3\textwidth]{d940fc92-c117-4fc3-b16c-db659decd2a5-09_296_149_1146_1174}
\end{figure}

\textbf{Avvertimento:}
Prima di ogni trattamento, verificare che il prodotto nel manico sia sufficiente; in caso contrario, aggiungerne altro.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.4\linewidth]{pulizia}
\end{figure}
...
\begin{enumerate}
  \setcounter{enumi}{1}
  \item Viso: Lifting del viso / Rassodamento della pelle / Ringiovanimento della pelle / Miglioramento delle rughe.
\end{enumerate}
...
\begin{enumerate}
  ...
  \item Impianti cutanei con materiale metallico (è richiesta una prova prima del trattamento).
  \item Protesi dentarie (è richiesta una prova prima del trattamento).
...
\subsubsection{Configurazione del trattamento}

\begin{table}[H]
	\small
	\setlength{\tabcolsep}{4pt} % riduce lo spazio tra le colonne
	\begin{tabular}{|p{4.5cm}|p{2.8cm}|p{2.5cm}|p{2.8cm}|}
		\hline
		\textbf{Articolo} & \textbf{Tempo trattamento singolo (Min)} & \textbf{Tempo di trattamento} & \textbf{Intervallo di trattamento (giorno)} \\
		\hline
		...
		\hline
		Miglioramento della pelle delle guance e trattamento antirughe & 20 & 10 & 23 \\
		\hline
...
\subsubsection{Impostazioni di alimentazione}
...
\begin{table}[H]
	...
	\begin{tabular}{|p{2.5cm}|p{2.5cm}|p{2.5cm}|p{5.5cm}|}
		\hline
		\textbf{Parte} & \textbf{Energia di Radiofrequenza} & \textbf{Energia di vibrazione} & \textbf{Reazione efficace} \\
		\hline
...
\begin{enumerate}
  ...
  \begin{figure}[H]
  	\centering
  	\includegraphics[width=0.4\textwidth]{d940fc92-c117-4fc3-b16c-db659decd2a5-14_547_382_1420_964}
  \end{figure}
\end{enumerate}

\subsubsection{Pannello di installazione}

Posizionare la piastra sulla schiena del cliente, sempre a contatto con la pelle:

\begin{figure}[H]
\centering
  \includegraphics[width=0.6\textwidth]{d940fc92-c117-4fc3-b16c-db659decd2a5-15_627_497_404_778}
\end{figure}
...
\begin{enumerate}
  ...
  \item Assicurarsi che la punta di trattamento sia completamente a contatto con la pelle. Far scorrere il prodotto sulle aree da trattare. Premere l'interruttore sull'impugnatura.
  \item La spia luminosa sulla punta non scorre molto bene. %?
\end{enumerate}
...
\begin{enumerate}
  ...
  \begin{figure}[H]
  	\centering
  	\includegraphics[width=0.6\textwidth]{d940fc92-c117-4fc3-b16c-db659decd2a5-15_638_615_1818_242}
  \end{figure}
\end{enumerate}

\textbf{Regola la velocità di scorrimento, la frequenza radio e la vibrazione:}
\begin{enumerate}
...
\textbf{Rassodamento della pelle:} Eseguire movimenti circolari dal basso verso l'alto seguendo la texture della pelle. \\
\textbf{Lifting della pelle:} Lungo la trama della pelle, solleva la pelle per riscaldare le fibre di collagene, mantenendo la stessa direzione di contrazione;
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{d940fc92-c117-4fc3-b16c-db659decd2a5-16_410_371_676_278}
\end{figure}

\textbf{trattamento definito:} Pieghe naso-labiali, rughe periorali, gonfiore sotto gli occhi, zona del viso difficile da trattare, rughe e pori dilatati.
...
\begin{enumerate}
  ...
  \begin{figure}[H]
  	\centering
  	\includegraphics[width=0.6\textwidth]{d940fc92-c117-4fc3-b16c-db659decd2a5-16_406_374_1443_246}
  \end{figure}
\end{enumerate}

\subsubsection{Trattamento della zona degli occhi}
\paragraph{Rassodamento della pelle:}
\begin{enumerate}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{d940fc92-c117-4fc3-b16c-db659decd2a5-17_433_719_301_246}
\end{figure}
...
\begin{enumerate}
  ...
  \begin{figure}[H]
  	\centering
  	\includegraphics[width=0.6\textwidth]{d940fc92-c117-4fc3-b16c-db659decd2a5-17_476_680_879_246}
  \end{figure}
\end{enumerate}

\paragraph{Rughe morbide:}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{d940fc92-c117-4fc3-b16c-db659decd2a5-17_479_675_1507_242}
\end{figure}
...
\input{../cose da aggiungere/consenso informato/consenso_ELETTROPULSE+.tex}
