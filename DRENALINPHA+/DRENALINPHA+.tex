...
\title{\Huge{DRENALINPHA+\\Manuale d'uso}}
\date{}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\linewidth]{images/DRENALINPHA+_copertina}
\end{figure}
...
\input{../cose da aggiungere/consenso informato/consenso_DRENALINPHA+.tex}
