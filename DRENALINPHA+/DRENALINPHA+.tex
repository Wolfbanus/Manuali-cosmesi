...
\graphicspath{{./images/}{../../cose da aggiungere/pittogrammi}}
\usepackage{amsmath}
\usepackage{amsfonts}
\usepackage{amssymb}
...
\usepackage{titling}
\pretitle{\begin{center}\includegraphics[width=\textwidth]{/home/keyser/Coding/cosmesi_ale/cose da aggiungere/header_WATT+.png}\\[6em]}
...
%\section{CONSENSO INFORMATO PER TRATTAMENTI CON DRENALINPHA+}
%\noindent lo sottoscritto/a nato/a\\
%il\\
%Residente in Via/Piazza\\
%Cap\\
%Città\\
%Pr\\
%\includegraphics[max width=\textwidth, alt={}, center]{88087b73-f534-48df-a915-fe697c64a27c-41_78_926_350_232}
%
%\noindent Cod. Fiscale\\
%Tel/Cell\\
%E-mail\\
...
%$\square$ \textbf{Autorizzo e accetto lo svolgimento del trattamento da me richiesto al minore di cui sopra, assumendone tutte le responsabilità.}
%
%\subsection{DESCRIZIONE TRATTAMENTO}
%Il metodo si basa su massaggio meccanico prodotto da apparecchiatura.\\
%Il (apparecchiatura) è un trattamento medico ed estetico, che migliora il rendimento del sistema circolatorio e del sistema linfatico rendendoli più efficiente e migliorando di conseguenza gli inestetismi più frequenti: cellulite, adiposità localizzata, ritenzione di liquidi. La sequenza pressoria favorisce l'entrata del liquido interstiziale nei vasi linfatici e nell'albero circolatorio, attivandone stimolandone il naturale percorso. Riduce il gonfiore e l'edema. Riduce gli stati infiammatori di natura non-infettiva. Migliora l'ossigenazione cutanea. Migliora il tono e l'integrità della pelle. Riduce con buoni risultati la cellulite e ridefinisce la forma delle gambe. Riduce con buoni risultati il linfedema post-operatorio. Allevia il dolore indotto da alcuni sportivi. Riduce l'edema post-traumatico. Favorisce l'eliminazione dal corpo delle tossine e dei prodotti di scarto. Riduce lo stress e favorisce il rilassamento.
%
%In genere, il consiglio è suddividere le varie sedute previste in $1 / 2$ appuntamenti a settimana.\\
%Una volta terminato il ciclo di sedute consigliato è indicato effettuare cicli di mantenimento se ritenuto necessario dall'operatore.
%
%\subsection{ALCUNI CONSIGLI}
%Per mantenere più a lungo gli effetti del trattamento , si consigliano di: adottare uno stile di vita che prevenga la ritenzione idrica, evitare alcolici, non fumare, ridurre il sale nella dieta, una buona idratazione interna, regolare attività fisica e infine tenere gli arti oggetto di trattamento in scarico (quando possibile).
%
%\subsection{CONTROINDICAZIONI:}
%\textbf{Controllare sempre e comunque le indicazioni riportate nel seguente manuale e personalizzare il consenso informato}
%
%Persone con emofilia, pacemaker, malattie cardiovascolari, allergie alla pelle, persone con febbre, Donne in gravidanza, Portatori di Handicap, minore età, epilessia, dispositivi di incontinenza, pompa insulina, insufficienza cardiaca, lesioni cutanee: erisipela, micosi, piodermiti, linfangiti, tromboflebiti, flebite, tubercolosi, insufficienza arteriosa periferica grave, plessopatia e neuropatia, gravi infezioni, tumori, ipertensione, ipotensione, asma, problemi renale, fragilità capillari, Sciatica, edema linfatico, neoplasie, arteriopatia obliterante periferica, dermoipodermiti, grave arteriosclerosi, diabete mellito con microangiopatia. \textbf{Riportare le indicazioni delle avvertenze e controindicazioni}
%
%\textbf{Ps. (In caso di dubbi è sempre meglio chiedere consiglio al proprio medico di base) INFORMAZIONI GENERALI}
%
%\vspace{10pt}
%Ho avuto modo di discutere in maniera adeguata ed esauriente le caratteristiche del trattamento in questione con $\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_$ che mi ha esposto in termini a me pienamente comprensibili le tecniche attualmente disponibili per l'effettuazione del trattamento da me desiderato. Mi è stato inoltre adeguatamente spiegato che il beneficio atteso da tale trattamento si raggiunge con più sedute ed è soggettivo. I trattamenti vengono effettuati con cadenza settimanale personalizzata ed indicata dell'operatore. Una volta terminato il ciclo di trattamenti consigliato, è indicato proseguire se si ritiene necessario con sedute di mantenimento.\\
%Mi è stato illustrato in modo completo che in taluni casi il risultato può essere insoddisfacente per una buona risposta individuale, indipendente dal trattamento. In questi casi non può essere richiesto rimborso. Ho avuto quindi ampia e dettagliata spiegazione sul procedimento, rischi, effetti collaterali. Sono cosciente ed accetto che se interrompo il ciclo di sedute di mia spontanea volontà, per gravidanza o per malattia non potrò richiedere il rimborso delle sedute effettuate né all'operatore né al centro estetico.\\
%Mi è stata data ampia spiegazione dei comportamenti e precauzioni da tenere prima e dopo il trattamento.\\
...
%Con questa dichiarazione, quindi, dopo aver compreso tutte le informazioni sopra elencate che mi sono state esposte esaurientemente e comprensibilmente chiedo di essere sottoposto al trattamento con la (nome apparecchiatura).\\
%lo sottoscritto/a $\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_$ dichiaro di aver letto attentamente il foglio informativo allegato e dichiaro il mio consenso a sottopormi al trattamento .
%
%\vspace{10pt}
%Data $\_\_\_\_$ / $\_\_\_\_$ / $\_\_\_\_$
%
%\vspace{15pt}
%Firma del Cliente $\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_$

\section{CONSENSO INFORMATO}
\section{Trattamento estetico "Drenalinpha+"}
