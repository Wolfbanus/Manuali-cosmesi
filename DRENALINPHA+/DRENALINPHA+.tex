...
\usepackage{titling}
\pretitle{\begin{center}\includegraphics[width=\textwidth]{../cose da aggiungere/header_WATT+.png}\\[6em]}
...
\input{../cose da aggiungere/consenso informato/consenso_informato_DRENALINPHA+.tex}
