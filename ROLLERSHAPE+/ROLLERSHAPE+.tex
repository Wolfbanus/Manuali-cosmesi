...
\newcommand{\imm}[2][1.2cm]{\includegraphics[width=#1]{#2}}

\usepackage{titling}
\pretitle{\begin{center}\includegraphics[width=\textwidth]{images/WATT+}\\[6em]}
...
\title{\Huge ROLLERSHAPE+\\Manuale d'uso}   
\date{}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth]{images/ROLLERSHAPE+_copertina}
\end{figure}
...
\begin{itemize}
	...
	\item
	Manico piccolo: da utilizzare su viso, collo e spalle.
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.7\textwidth]{31d8a32b-88de-483b-82f7-0d2b231ca911-07_1043_1211_648_395}
	\end{figure}
	\item 
	Manico grande: da utilizzare sul corpo.
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.8\textwidth]{31d8a32b-88de-483b-82f7-0d2b231ca911-08_1447_1667_411_207}
	\end{figure}
%
	\begin{figure}[H]
		\begin{center}
			\includegraphics[width=0.5\textwidth]{31d8a32b-88de-483b-82f7-0d2b231ca911-08_284_446_2101_157}
			\captionsetup{labelformat=empty}
...
%	
	\begin{figure}[H]
		\begin{center}
			\includegraphics[width=0.7\textwidth]{31d8a32b-88de-483b-82f7-0d2b231ca911-08_291_632_2101_641}
			\captionsetup{labelformat=empty}
			\caption{Rotazione in senso orario\\
				(Abbreviazione: rotazione)}
		\end{center}
	\end{figure}
%	
	\begin{figure}[H]
		\begin{center}
			\includegraphics[width=0.7\textwidth]{31d8a32b-88de-483b-82f7-0d2b231ca911-08_296_632_2101_1315}
			\captionsetup{labelformat=empty}
	...
	\end{figure}
	\item 
	La sostituzione e l'installazione del rullo integrato nella maniglia sono illustrate nella figura seguente:
%	
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.7\textwidth]{31d8a32b-88de-483b-82f7-0d2b231ca911-09_318_702_781_189}
		\captionsetup{labelformat=empty}
		\caption{1. Premere e tenere premuti contemporaneamente i pulsanti su entrambi i lati.}
	\end{figure}
%	
	\begin{figure}[H]
		\begin{center}
			\includegraphics[width=\textwidth]{31d8a32b-88de-483b-82f7-0d2b231ca911-09_301_1477_424_182}
			\captionsetup{labelformat=empty}
...
%	
	\begin{figure}[H]
		\begin{center}
			\includegraphics[width=0.7\textwidth]{31d8a32b-88de-483b-82f7-0d2b231ca911-09_286_693_804_1160}
			\captionsetup{labelformat=empty}
...
%	
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.7\textwidth]{31d8a32b-88de-483b-82f7-0d2b231ca911-09_298_753_1199_648}
		\captionsetup{labelformat=empty}
		\caption{4. Allinea il corpo dell'asse y. \\Installare il coperchio nello slot.}
	\end{figure}
\end{itemize}
...
\subsection{Pannello di controllo (interfaccia utente)}

\begin{longtable}{m{5cm} m{5cm}}
	\hline
	\textbf{Manico grande} & \imm{manico_grande.png} \\
	\textbf{Manico piccolo} & \imm{manico_piccolo.png} \\
	\hline
	\textbf{Direzione rotazione:} & \\
	Senso orario & \imm{rotazione_senso_orario.png} \\
	Senso antiorario & \imm{rotazione_senso_antiorario.png} \\
	\hline
	\textbf{Tempo di funzionamento} & 60 minuti, marce 1–10 (intervallo 5 min) \\
	\hline
	\textbf{Velocità (1–10)} & \imm{velocita.png} \\
	Diminuisci & \imm{diminuire_velocita.png} \\
	Aumenta & \imm{aumentare_velocita.png} \\
	\hline
	\textbf{Comandi esecuzione:} & \\
	Start & \imm{start.png} \\
	Pausa & \imm{pause.png} \\
	\hline
	\textbf{Memorizzazione parametri (M1–M5)} & \imm{salvataggio.png} \\
	\hline
	\textbf{Pulsante ritorno} & \imm{back.png} \\
	\hline
	\textbf{Luce} & \imm{luce.png} \\
	\textbf{Modalità} & \imm{modalita.png} \\
	\hline
	\caption{Pannello di controllo}
\end{longtable}

%\begin{itemize}[label={}]
%	\item $\square$ Manico grande
%	\item $\square$ Manico piccolo
%	
%	\item \textbf{Direzione di rotazione:}
%	\begin{itemize}[label={}]
%		\item $\Circle$ Orario
%		\item $\Circle$ Antiorario
%	\end{itemize}
%	
%	\item \textbf{Tempo di funzionamento:} 60 minuti, marce da 1 a 10 (intervallo tra marce: 5 minuti) \\
%	\texttt{[60:00]}
%	
%	\item \textbf{Velocità:} regolazione da 1 a 10 \\
%	Pulsante Diminuisci: $\square$ \\
%	Pulsante Avvia: $\square$ \\
%	Pulsante Pausa: $\square$ \\
%	$\square$ Pausa (checkbox separata)
%	
%	\item \textbf{Memorizzazione parametri:} M1, M2, M3, M4, M5 (memorizzazione/richiamo)
%	\begin{itemize}[label={}]
%		\item $\square$ M1 \quad $\square$ M2 \quad $\square$ M3 \quad $\square$ M4 \quad $\square$ M5
%	\end{itemize}
%	
%	\item $\square$ Pulsante miscelazione
%	\item $\square$ Pulsante ritorno
%	\item $\square$ Seleziona luce (on/off)
%	\item $\square$ Modalità
%\end{itemize}
...
\section{Parametri del prodotto}
...
Fusibile & 5A \\
\hline
manico grande & 50 palline in silicone (per la cura del corpo) \\
\hline
manico piccolo & 60 palline in silicone (per la cura del viso e del collo) \\
\hline
...
\input{../cose da aggiungere/consenso informato/consenso_ROLLERSHAPE+.tex}
